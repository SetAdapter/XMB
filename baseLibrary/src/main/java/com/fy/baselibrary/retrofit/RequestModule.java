...
//    @Singleton
//    @Provides
//    protected DES3GsonConverterFactory getQulifierGsonConvertFactory() {
//        return DES3GsonConverterFactory.create();//使用 自定义 GsonConverter
//    }

    @Singleton
    @Provides
    protected OkHttpClient getClient(ReceivedCookiesInterceptor receivedCookiesInterceptor,
                                     AddCookiesInterceptor addCookiesInterceptor,
                                     HttpLoggingInterceptor interceptor, Interceptor header) {
    ...
    @Singleton
    @Provides
    protected ReceivedCookiesInterceptor getReceivedCookies(){
        return new ReceivedCookiesInterceptor();
    }

    @Singleton
    @Provides
    protected AddCookiesInterceptor getAddCookies(){
