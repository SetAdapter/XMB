...
public final class DaggerRequestComponent implements RequestComponent {
  ...
  private Provider<ReceivedCookiesInterceptor> getReceivedCookiesProvider;

  private Provider<AddCookiesInterceptor> getAddCookiesProvider;
  ...
  private void initialize(final Builder builder) {
    ...
    this.getReceivedCookiesProvider =
        DoubleCheck.provider(RequestModule_GetReceivedCookiesFactory.create(builder.requestModule));

    this.getAddCookiesProvider =
        DoubleCheck.provider(RequestModule_GetAddCookiesFactory.create(builder.requestModule));
    ...
    this.getClientProvider =
        DoubleCheck.provider(
            RequestModule_GetClientFactory.create(
                ...
                getReceivedCookiesProvider,
                getAddCookiesProvider,
                getResponseInterceptProvider,
                getHeaderProvider));
